...
<html>
<head>
<title>ComeUp a Entertainment Category Flat Bootstrap Responsive Website Template | Blogs :: w3layouts</title>
    ...
    <section>
      <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="index.html">ComeUp<span>c</span></a></h1>
			</div>
			<div class="logo-icon text-center">
				<a href="index.html">ComeUp</a>
			</div>
			...
			<!--logo and iconic logo end-->
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="typography.html"><i class="lnr lnr-user"></i> <span>Profile</span></a></li>
				...
				<div class="modal-dialog facebook" role="document">
					<div class="modal-content">
						...
						<div class="col-md-5 app-left mpl">
							<h3>ComeUp mobile app on your smartphone!</h3>
							  ...
							  <!-- search-scripts -->
									...
									<!-- //search-scripts -->
											...
											<div class="col-md-4 login-pop">
												<div id="loginpop"><!--<a href="index.php" id="loginButton"><span>Upload <i class="arrow glyphicon glyphicon-chevron-right"></i></span></a>--><a class="top-sign" href="index.php">Upload</a>
		...
		<div class="col-lg-3 col-sm-6">
            ...
            <div class="card hovercard">
                ...
                <div class="info">
                    ...
                    <div class="desc">Artist desc1</div>
                    <div class="desc">Artist desc1</div>
                    <div class="desc">Artist desc1</div>
                </div>
                <div class="bottom">
                    ...
                    <a class="btn btn-primary btn-instagram btn-sm" href="https://twitter.com/webmaniac">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="alert alert-success" style="display:none;">
                <span class="glyphicon glyphicon-ok"></span> Arrange Your Songs</div>
            <table class="table">
                <thead>
                    <tr>
                        <th>
